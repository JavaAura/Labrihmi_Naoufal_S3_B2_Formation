...
@Api(tags = "Gestion des Apprenants", description = "API pour la gestion des apprenants")
@Validated
public class ApprenantController {
        ...
        public ResponseEntity<ApiResponse> update(
                ...
                try {
                        ...
                        return ResponseEntity.ok(new ApiResponse(true,
                                        "Apprenant mis à jour avec succès", updated));
                } catch (ResourceNotFoundException | ValidationException e) {
                        throw e;
                } catch (Exception e) {
                        logger.error("Error updating apprenant: ", e);
                        throw new ValidationException("Erreur lors de la mise  jour de l'apprenant");
                }
        }
        ...
        @ApiResponses(value = {
                        @io.swagger.annotations.ApiResponse(code = 200, message = "Liste des apprenants récupérée avec succès", response = Page.class)
        })
        ...
        public ResponseEntity<ApiResponse> findByNiveau(
